...
public final class DatapointHelper 
{
     ...
     */
    public static String formatControllerValue(final String paramName, final String paramValue)
    {
        ...
        formattedString.append(paramName);
        formattedString.append(": ");
        
        // It is possible for some parameter values to be null. 
        if(paramValue == null) 
        {
        	formattedString.append("");
        }
        ...
        {
        	formattedString.append(paramValue);
        }
        formattedString.append("\n");
    ...
    /**
     * Returns the given datapoint as a formatted YAML string to be stored in the session file.
     ...
     */
    public static String formatDatapoint(final String paramName, final String paramValue)
    {
    	// A datapoint variable is exactly the same as a controller value, except it has
    	// a leading space which move it to the second level of data.
    	return formatControllerValue(" " + paramName, paramValue);    	
    }    
